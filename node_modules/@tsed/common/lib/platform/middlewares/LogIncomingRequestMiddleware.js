...
exports.LogIncomingRequestMiddleware = void 0;
...
let LogIncomingRequestMiddleware = LogIncomingRequestMiddleware_1 = class LogIncomingRequestMiddleware {
    ...
    configureRequest(request) {
        request.ctx.logger.minimalRequestPicker = (obj) => ({ ...this.minimalRequestPicker(request), ...obj });
        request.ctx.logger.completeRequestPicker = (obj) => ({ ...this.requestToObject(request), ...obj });
    }
    /**
