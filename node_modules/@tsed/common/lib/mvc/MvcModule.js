...
MvcModule = tslib_1.__decorate([
    di_1.Module({
        imports: [ConverterModule_1.ConverterModule, ParseService_1.ParseService, ValidationService_1.ValidationService, jsonschema_1.JsonSchemesService]
    })
], MvcModule);
