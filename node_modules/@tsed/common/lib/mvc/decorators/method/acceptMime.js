...
function AcceptMime(...mimes) {
    return core_1.useDecorators(core_1.StoreSet(AcceptMimesMiddleware_1.AcceptMimesMiddleware, mimes), useBefore_1.UseBefore(AcceptMimesMiddleware_1.AcceptMimesMiddleware));
}
