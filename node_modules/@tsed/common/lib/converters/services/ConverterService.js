...
const PropertyMetadata_1 = require("../../mvc/models/PropertyMetadata");
...
let ConverterService = ConverterService_1 = class ConverterService {
    ...
    serializeClass(obj, options = {}) {
        ...
        const plainObject = {};
        const properties = PropertyMetadata_1.PropertyMetadata.getProperties(options.type || obj, { withIgnoredProps });
        const keys = properties.size ? Array.from(properties.keys()) : core_1.objectKeys(obj);
    ...
    deserialize(obj, targetType, baseType, options = {}) {
        ...
        // Default converter
        const instance = new targetType();
        const properties = PropertyMetadata_1.PropertyMetadata.getProperties(targetType);
        core_1.objectKeys(obj).forEach((propertyName) => {
