...
export declare class InjectorService extends Container {
     ...
     * @param invokeOptions
     */
    bindProperty(instance: any, { propertyKey, useType, options }: IInjectablePropertyService, locals: Map<TokenProvider, any>, invokeOptions: Partial<IInvokeOptions>): void;
    /**
     *
     * @param instance
     * @param {string} propertyKey
