...
exports.NetworkAuthenticationRequired = void 0;
const Exception_1 = require("../core/Exception");
class NetworkAuthenticationRequired extends Exception_1.Exception {
    constructor(message, origin) {
        super(NetworkAuthenticationRequired.STATUS, message, origin);
        this.name = "NETWORK_AUTHENTICATION_REQUIRED";
    }
}
